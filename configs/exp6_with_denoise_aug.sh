#!/bin/bash
# Experiment 6: Full + Denoising Augmentation
# All improvements + data augmentation for enhanced denoising
# Expected: 60-80% noise reduction (best denoising)

python train.py \
  --name exp6_with_denoise_aug \
