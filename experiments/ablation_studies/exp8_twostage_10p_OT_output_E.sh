...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp8_2s10_out_E

# Experiment 8: Two-Stage 10% - OT Output + Entropy
# Load pretrained, 10% paired data, OT_output + entropy loss
...
echo "=========================================="
echo "Experiment 8: Two-Stage 10% - OT Output + Entropy"
echo "=========================================="
...
# Experiment setup
export EXPERIMENT_NAME="ablation_exp8_twostage_10p_OT_output_E"
...
if [ $exit_code -eq 0 ]; then
    echo "Training completed: Experiment 8"
else
    echo "Training failed: Experiment 8"
fi
echo "=========================================="
