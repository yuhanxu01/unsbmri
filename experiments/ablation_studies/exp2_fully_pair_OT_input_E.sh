...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp2_OT_in_E

# Experiment 2: Fully Paired - OT Input + Entropy
# From scratch, 100% paired data, OT_input + entropy loss
...
echo "=========================================="
echo "Experiment 2: Fully Paired - OT Input + Entropy"
echo "=========================================="
...
# Experiment setup
export EXPERIMENT_NAME="ablation_exp2_fully_pair_OT_input_E"
...
if [ $exit_code -eq 0 ]; then
    echo "Training completed: Experiment 2"
else
    echo "Training failed: Experiment 2"
fi
echo "=========================================="
