...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp1_OT_in

# Experiment 1: Fully Paired - OT Input Only
# From scratch, 100% paired data, only OT_input loss
...
echo "=========================================="
echo "Experiment 1: Fully Paired - OT Input Only"
echo "=========================================="
...
# Experiment setup
export EXPERIMENT_NAME="ablation_exp1_fully_pair_OT_input"
...
if [ $exit_code -eq 0 ]; then
    echo "Training completed: Experiment 1"
else
    echo "Training failed: Experiment 1"
fi
echo "=========================================="
