...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp5_2s10_in

# Experiment 5: Two-Stage 10% - OT Input Only
# Load pretrained, 10% paired data, only OT_input loss
...
echo "=========================================="
echo "Experiment 5: Two-Stage 10% - OT Input Only"
echo "=========================================="
...
if [ $exit_code -eq 0 ]; then
    echo "Training completed: Experiment 5"
else
    echo "Training failed: Experiment 5"
fi
echo "=========================================="
