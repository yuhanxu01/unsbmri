...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp6_2s10_in_E

# Experiment 6: Two-Stage 10% - OT Input + Entropy
# Load pretrained, 10% paired data, OT_input + entropy loss
...
echo "=========================================="
echo "Experiment 6: Two-Stage 10% - OT Input + Entropy"
echo "=========================================="
...
# Experiment setup
export EXPERIMENT_NAME="ablation_exp6_twostage_10p_OT_input_E"
...
if [ $exit_code -eq 0 ]; then
    echo "Training completed: Experiment 6"
else
    echo "Training failed: Experiment 6"
fi
echo "=========================================="
