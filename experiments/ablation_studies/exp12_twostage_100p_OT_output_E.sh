...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp12_2s100_out_E

# Experiment 12: Two-Stage 100% - OT Output + Entropy
...
echo "=========================================="
echo "Experiment 12: Two-Stage 100% - OT Output + Entropy"
echo "=========================================="
...
# Experiment setup
export EXPERIMENT_NAME="ablation_exp12_twostage_100p_OT_output_E"
...
if [ $exit_code -eq 0 ]; then
    echo "Training completed: Experiment 12"
else
    echo "Training failed: Experiment 12"
fi
echo "=========================================="
