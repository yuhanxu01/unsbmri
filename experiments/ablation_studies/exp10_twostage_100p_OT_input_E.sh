...
#SBATCH --mem=16G
#SBATCH --gres=gpu:1
#SBATCH --job-name=exp10_2s100_in_E

# Experiment 10: Two-Stage 100% - OT Input + Entropy
# Load pretrained, 100% paired data, OT_input + entropy loss
...
echo "=========================================="
echo "Experiment 10: Two-Stage 100% - OT Input + Entropy"
echo "=========================================="
...
# Experiment setup
export EXPERIMENT_NAME="ablation_exp10_twostage_100p_OT_input_E"
...
if [ $exit_code -eq 0 ]; then
    echo "Training completed: Experiment 10"
else
    echo "Training failed: Experiment 10"
fi
echo "=========================================="
